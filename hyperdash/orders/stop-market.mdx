...
<Note>
  A stop market guarantees the exit, not the price. If capping your worst fill matters more, use a [Stop Limit](/hyperdash/orders/stop-limit) and accept the risk of resting unfilled.
</Note>
