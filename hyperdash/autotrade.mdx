...
<Steps>
  ...
  <Step title="Start and manage">
    Press **Start**. The wallet shows as Running on the Copytrade tab with its equity, PNL, positions, and logs. Open your** Copytrade Settings** any time to edit configuration, pause, or resume.
  </Step>
</Steps>
