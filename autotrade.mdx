...
<Steps>
  <Step title="Choose your targets">
    Start from a trader profile, the Copytraders section of [Explore](/wallet-explore), or paste any wallet address. One Copytrade wallet can follow up to 10 traders, with capital split equally or by custom weights.
  </Step>
