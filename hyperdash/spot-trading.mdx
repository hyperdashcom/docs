...
Each order type has its own reference page: start with the [Order Types overview](/hyperdash/orders/overview), or jump to [Market](/hyperdash/orders/market), [Limit](/hyperdash/orders/limit), [Scale](/hyperdash/orders/scale), [Stop Limit](/hyperdash/orders/stop-limit), [Stop Market](/hyperdash/orders/stop-market), [Chase](/hyperdash/orders/chase), [TWAP](/hyperdash/orders/twap), or [Swarm](/hyperdash/orders/swarm).
...
<AccordionGroup>
  <Accordion title="Can I short on spot?">
    No. Spot sells are limited to the balance you hold. For short exposure, use a perp market: see the [Trading Guide](/hyperdash/trading-guide).
  </Accordion>

  <Accordion title="How do I fund my spot balance?">
    Deposit directly, or transfer USDC from your perps account with the **Perps to Spot** button. See [Onboarding and Deposits](/hyperdash/onboarding-deposits).
  </Accordion>

  <Accordion title="Do spot trades pay funding?">
    No. Funding applies only to perpetuals. Spot costs are the maker and taker fee rates shown in the order form; see [Fees, Referrals and Rewards](/hyperdash/fees-referrals-rewards).
  </Accordion>
