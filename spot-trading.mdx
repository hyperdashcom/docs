...
<Steps>
  ...
  <Step title="Choose an order type">
    Market and Limit are top-level tabs. The **Pro** dropdown adds Scale, Chase, TWAP, Chase TWAP, and Swarm, plus the conditional types Stop Limit and Stop Market.
  </Step>
...
Each order type has its own reference page: start with the [Order Types overview](/orders/overview), or jump to [Market](/orders/market), [Limit](/orders/limit), [Scale](/orders/scale), [Stop Limit](/orders/stop-limit), [Stop Market](/orders/stop-market), [Chase](/orders/chase), [TWAP](/orders/twap), [Chase TWAP](/orders/chase-twap), or [Swarm](/orders/swarm).
