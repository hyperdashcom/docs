...
description: "Gambaran singkat trading di Hyperdash dan jenis order."
---
...
**Stealth : **Mengeksekusi TWAP Anda melalui infrastruktur kami alih-alih on-chain untuk eksekusi yang lebih privat.

**Acak waktu dan/atau ukuran (Opsional):** Jika Acak diaktifkan, ukuran dan waktu setiap sub-perdagangan akan disesuaikan secara otomatis dalam rentang tertentu, biasanya hingga 20% lebih tinggi atau lebih rendah dari ukuran perdagangan asli dan dieksekusi 20% lebih awal atau lebih lambat.
...
Membagi order Anda menjadi sub-order yang lebih kecil dan menempatkannya dari waktu ke waktu untuk mengurangi dampak pasar.

Total order dapat dibagi menjadi hingga 200 sub-order (ukuran minimum \$10 per sub-order)\
\
Pilih 'Level Agresi' antara 1-5, agresi lebih tinggi menempatkan order lebih sering untuk pengisian lebih cepat.
