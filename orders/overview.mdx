...
| [Chase](/orders/chase) | Post-only limit order that rests one tick inside the far side of the book, repricing continuously | Fast fills while staying passive | Chase To, Reduce Only |
...
| [Chase TWAP](/orders/chase-twap) | One-minute clips worked as passive chase orders, with a market sweep every five minutes | TWAP pacing with maker pricing | Duration, Refresh Aggression |
